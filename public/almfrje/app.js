...
const GUIDE = [
  ...
  { sec: '📊 الإحصائيات والتقارير', items: [
    { t: 'التقرير الإحصائي الكامل', fn: 'لوحة أرقامٍ شاملة عن القبيلة في صفحة واحدة.', brief: 'المزيد ← 📊 الإحصائيات ← «الإحصائيات الكاملة»، أو زر «📈 التقرير الإحصائي الكامل» أسفل مربّعات الرئيسية.', det: 'يجمع كل الإحصاءات: (١) إحصاءات عامة — إجمالي الأفراد والفروع والأجيال، مع ثلاثة مربّعات ملوّنة مجسّمة: الأحياء، والمتوفّون الذين لهم ذرية، ومن لم يعقب. (٢) عدد كل جيل مفصّلاً (إجمالي الجيل • حيّ • متوفّى • لم يعقب بألوان الحالة). (٣) الفروع مرتّبة حسب العدد. (٤) أكبر البيوت (الأكثر ذرّيةً) مع نسب كلٍّ منها. (٥) أكثر الأسماء شيوعاً. (٦) التوزيع حسب المدينة. (٧) الزيارات: الإجمالي وحسب الفرع وحسب المنطقة. يتحدّث تلقائياً مع تغيّر البيانات.' },
  ]},
...
const FAQ = [
  ...
  { q: 'أين أجد الإحصائيات الكاملة؟', a: 'من «المزيد ← 📊 الإحصائيات ← الإحصائيات الكاملة»، أو زر «📈 التقرير الإحصائي الكامل» أسفل مربّعات الرئيسية. يعرض الأعداد العامة وكل جيل والفروع وأكبر البيوت وأكثر الأسماء والتوزيع حسب المدينة والزيارات.' },
