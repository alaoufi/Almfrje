...
function screenMore() {
  ...
  trees.push(['🌳 الشجرة الطبيعية (جذور وغصون وأوراق)', '/almfrje/tree-nature.html']);
...
const GUIDE = [
  ...
  { sec: '🌳 العرض والتصفّح', items: [
    ...
    { t: 'الشجرة الطبيعية', fn: 'عرض القبيلة كشجرةٍ تحاكي الطبيعية: جذور وجذع وغصون وأوراق.', brief: 'المزيد ← «الشجرة الطبيعية»: لوحة واحدة كبيرة تُسحب بكل الاتجاهات وتتكبّر وتتصغّر.', det: 'الجذع ينبت من أرضٍ لها جذور، وكل أبٍ غصنٌ (تزداد سماكته بحجم ذرّيته) واسمه عليه، وكل فردٍ بلا ذرية ورقة: خضراء = حيّ، حمراء داكنة = متوفّى لم يعقب، وظلّة خضراء واحدة تحتضن التاج كله. اسحب بإصبعك بكل الاتجاهات، وكبّر بإصبعين (أو عجلة الفأرة) وبأزرار ＋/−، وزر ⤢ يلائم الشجرة في الشاشة، وإن ابتعدت يظهر زر «توسيط الشجرة» يعيدك. ولمس أي ورقةٍ أو اسمٍ يعرض نسبه كاملاً وعدد ذرّيته. الأسماء تظهر عند الاقتراب وتُخفى عند الابتعاد لسرعة الحركة، ومؤشر تحميلٍ رقمي يعرض تقدّم جلب الأسماء.' },
...
const FAQ = [
  ...
  { role: 'admin', q: 'كيف أضيف مشرفاً جديداً؟', a: 'لوحة التحكم ← المستخدمون ← «➕ إضافة مستخدم»: اكتب الاسم فيُنتقى من الشجرة (لا بدّ أن يكون حيّاً)، ثم أدخل رقم الجوال والرقم السري، واختر الدور (مشرف عام/مشرف فرع)، وحدّد الفروع والصلاحيات، ثم «إنشاء الحساب وتفعيله». ويدخل المشرف بجوّاله ورقمه السري.' },
  ...
  { role: 'admin', q: 'نسيَ مستخدمٌ رقمه السري — ماذا أفعل؟', a: 'من لوحة التحكم ← المستخدمون ← بطاقة المستخدم ← «✎ تعديل البيانات»، يعيّن المدير رقماً سرياً جديداً.' },
