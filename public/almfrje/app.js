...
const ROUTES = {
  ...
  guide: { t: 'دليل الموقع', back: true, fn: screenGuide },
};
...
function screenMore() {
  ...
  browse.push(['📖 دليل الموقع (شرح مفصّل)', '#/guide']);
...
const GUIDE = [
  { sec: '🚪 الدخول والوصول', items: [
    ...
    { t: 'دخول المسؤول / مشرف الفرع', fn: 'دخول الإدارة لإضافة البيانات وتعديلها.', brief: 'عبر الرابط ‎#login‎ بالجوال أو اسم المستخدم والرقم السري.', det: 'مدير النظام له صلاحية كاملة على كل الأقسام. مشرف الفرع يضيف ويعدّل ضمن فرعه المصرّح به فقط، ولا يرى أقسام الإدارة العامة.' },
  ]},
  { sec: '🏠 الرئيسية', items: [
    ...
    { t: 'الإحصائيات', fn: 'أرقام سريعة عن الشجرة.', brief: 'إجمالي الأفراد، عدد الفروع، عدد الأجيال، وعدد الزوّار.', det: '«الفروع» تَعُدّ الفروع القائمة فقط (التي أنجب مؤسّسها). «الزوّار» إجمالي كل من دخل الموقع (زائر/مشرف/مدير).' },
    ...
    { t: 'ملاحظات الزوار', fn: 'قناة تواصل لتصحيح الأخطاء أو طلب إضافة مولود.', brief: 'زر «أرسل ملاحظة للإدارة».', det: 'تظهر للمدير، وللمشرف ما يخصّ فرعه (مع عدّاد عند وجود طلبات معلّقة).' },
  ...
  { sec: '🌳 العرض والتصفّح', items: [
    { t: 'الشجرة التفاعلية', fn: 'تصفّح الأنساب هرمياً.', brief: 'اضغط «+» لفتح أبناء أي شخص و«−» لطيّهم.', det: 'الضغط على الاسم يفتح ملفه الكامل. وتظهر دلالة ألوان الحالة أسفل الشاشة.' },
  ...
  { sec: '🗂️ البيانات (للمدير ومشرف الفرع)', items: [
  ...
  { sec: '⚙️ لوحة التحكم (لمدير النظام)', items: [
    ...
    { t: 'النصوص', fn: 'تحرير نصوص الواجهة الظاهرة للجميع.', brief: 'عنوان الموقع وسطر «powered by» وكلمة المناسبات وبطاقة الملاحظات ودعوة الزائر ورسالة الشكر وترحيب الزائر وألوان الحالة.', det: 'وفيها إحصائيات الزيارات (الإجمالي/حسب الفرع/حسب المنطقة) وتصفير الزيارات وتصفير «آخر الإضافات». «كلمة المناسبات» تظهر تحت عنوان شاشة الدخول بخط غامق ولونٍ تختاره.' },
    ...
    { t: 'النسخ والتصدير', fn: 'حفظ نسخة كاملة وتصدير البيانات.', brief: 'نسخة احتياطية كاملة، وتصدير Excel/CSV/PDF.', det: 'أخذ النسخة لا يؤثّر على البيانات الحالية، ويمكن الاستعادة لاحقاً (لمدير النظام فقط).' },
  ]},
  { sec: '👤 حسابي وعام', items: [
    ...
    { t: 'الوضع الليلي وزر التحديث', fn: 'راحة العين وتحديث المحتوى.', brief: 'زر القمر للوضع الليلي، وزر 🔄 لتحديث الصفحة بالكامل.', det: 'زر التحديث يجلب أحدث نسخة من الموقع متجاوزاً ذاكرة المتصفّح.' },
  ]},
];
function screenGuide() {
  const toc = GUIDE.map((g, i) => `<button class="guide-toc-link" data-gsec="${i}">${g.sec}</button>`).join('');
  const body = GUIDE.map((g, i) => `
  ...
  view().innerHTML = `<div class="about-wrap"><div class="about-card guide-card">
      <p class="about-eyebrow">دليل الاستخدام</p>
      <h2>كتيّب تعليمات ${esc(siteTitle)}</h2>
      <hr>
      <p style="text-align:center;color:var(--muted);font-size:.9rem;margin:0 0 14px">شرح مفصّل لكل أقسام الموقع ووظائفها — يتحدّث مع كل تطوير للموقع.</p>
