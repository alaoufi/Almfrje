...
const GUIDE = [
  ...
  { sec: '🏠 الرئيسية', items: [
    ...
    { t: 'تهنئة المناسبات (مبارَكة)', fn: 'رسالة تهنئة من الإدارة في المناسبات.', brief: 'تظهر فور الدخول وكشريط ذهبي أعلى الرئيسية.', det: 'تكتبها الإدارة بلونٍ مميّز وتُنشَر فوراً أو بموعدٍ محدّد ولمدّةٍ معيّنة (بالساعات أو الأيام). تظهر النافذة مرّة لكل جلسة، ويبقى الشريط الذهبي أعلى الرئيسية ظاهراً طوال مدّة العرض.' },
