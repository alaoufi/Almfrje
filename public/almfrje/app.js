...
const GUIDE = [
  ...
  { sec: '🧭 أدوات المشجّرة', items: [
    ...
    { t: 'الشجرة الدائرية', fn: 'عرض بصري دائري للمشجّرة.', brief: 'المزيد → «الشجرة الدائرية».', det: 'الجذر في الوسط والأجيال حلقاتٌ حوله (٣ افتراضياً، حتى ٦). يمكن التكبير وتغيير الجذر، وتُجمَّع الفروع الكبيرة في «+عدد» يفتح فهرس الذرية، والضغط على أي اسمٍ يفتح العدسة.' },
    { t: 'نسخة مختصرة للطباعة', fn: 'مشجّرة نظيفة للطباعة أو PDF.', brief: 'المزيد → «نسخة مختصرة للطباعة».', det: 'اختر الفرع/الجدّ وعدد الأجيال وما يظهر (الحالة/المدينة/عدد الأبناء/الأحياء فقط)، فتُولَّد صفحة A4 نظيفة بلا أزرار، للطباعة أو حفظ PDF.' },
