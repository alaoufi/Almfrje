...
- `almfrje-presence` — يحتسب الحساب الموثق مرة واحدة مهما تعددت أجهزته، بمفتاح `account:<user_id>` ونافذة حضور 3 دقائق من آخر نبضة لأي جهاز. الاسم من العضوية والفرع من الشخص المرتبط (أو فرع العضوية عند غياب الربط)، ولا يعتمد على اسم أو فرع أو معرّف جهاز يرسله العميل. يعيد العدد والفروع من السجل نفسه، وقائمة الأسماء للمدير/المشرف العام فقط مع منع التخزين العام. سجلات الأجهزة القديمة المؤقتة تستبدل بالنبضات الجديدة؛ لا يتغير سجل الزيارات التاريخي.
